...
namespace PongGame
{
    ...
    public class Game1 : Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            PaddleBottom.Position = new Vector2(screenBounds.Center.X, screenBounds.Bottom - PaddleBottom.Size.Height);
            PaddleTop.Position = new Vector2(screenBounds.Center.X, screenBounds.Top);
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            {
                PaddleTop.Position.X -= (float)(PaddleBottom.Speed * gameTime.ElapsedGameTime.TotalMilliseconds);
            }
            if (touchState.IsKeyDown(Keys.D))
            {
                PaddleTop.Position.X += (float)(PaddleBottom.Speed * gameTime.ElapsedGameTime.TotalMilliseconds);
            }
            PaddleTop.Position.X = MathHelper.Clamp(PaddleTop.Position.X, bounds.Left, bounds.Right - PaddleTop.Size.Width);
